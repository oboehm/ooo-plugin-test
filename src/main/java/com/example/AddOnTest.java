...
public final class AddOnTest extends WeakBase implements com.sun.star.lang.XInitialization,
        com.sun.star.frame.XDispatch, com.sun.star.lang.XServiceInfo, com.sun.star.frame.XDispatchProvider {
    private final XComponentContext m_xContext;
    private com.sun.star.frame.XFrame m_xFrame;
    private static final String m_implementationName = AddOnTest.class.getName();
    private static final String[] m_serviceNames = { "com.sun.star.frame.ProtocolHandler" };

    public AddOnTest(XComponentContext context) {
        m_xContext = context;
    };
    ...
    public static XSingleComponentFactory __getComponentFactory(String sImplementationName) {
        ...
        if (sImplementationName.equals(m_implementationName))
            xFactory = Factory.createComponentFactory(AddOnTest.class, m_serviceNames);
        return xFactory;
    }

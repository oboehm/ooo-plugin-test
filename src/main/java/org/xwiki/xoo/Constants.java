...
public interface Constants {
    ...
    final static String CUSTOM_SETTINGS_DIALOG = "vnd.sun.star.script:dialogLibrary.CustomSettings?location=application";
    ...
    final static String[] errorMessages = { "Login failed! Please check the server URL, the username and password ", //
            ...
            "This page could not be published", //
            "This file format is not supported (temporal aproach)", //
            ...
            "The space name cannot be empty!", //
            "The page name cannot be empty", //
            "The page title cannot be empty", //
            "You should select a page in the XWiki navigation panel  in order to be able to perform this action", //
            "Download failed!", //
            "File already exists. Do you want to replace it?", //
            "Upload failed! Please save your document and try again.", //
            "Upload failed! File too big!", //
            "Upload failed!", //
            "Add space failed!", //
            "Page empty! Please save the page and try again!", //
    };
    ...
    final static String[] Messages = { "Login successfully done!", //
            "Page publish successfully done!", //
            "Download successfully done!", //
            "Upload successfully done!", //
            "Add space successfully done!" };
